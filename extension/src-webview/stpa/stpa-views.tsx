...
export class PolylineArrowEdgeView extends PolylineEdgeView {
    ...
    protected renderLine(edge: SEdgeImpl, segments: Point[], context: RenderingContext): VNode {
        ...
        class-feedback-dotted={feedbackEdge && dotted} class-feedback-grey={feedbackEdge && greyFeedback} class-coordination-edge={coordinationEdge} class-missing-edge={missing} class-invisible={invisEdge} class-greyed-out={greyed} aspect={aspect}>
